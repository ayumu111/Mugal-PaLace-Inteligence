...
static float[][] customW = {
  {1.0f, 0.1f, 10.0f}, {1000.0f, 0.01f, 0.1f}, {-1.0f, -1.0f, 0.1f}, {-1.0f, 100.0f, 1000.0f}, {0.01f, -0.1f, 1000.0f}, {1.0f, -10.0f, -1.0f}, {10.0f, 0.1f, 0.0f}, {-100.0f, 0.001f, -1.0f}, {-100.0f, -10.0f, 0.1f}, {-1000.0f, -100.0f, 0.01f}, {1000.0f, -100.0f, 0.1f}, {-0.1f, 10.0f, 0.001f}, {1000.0f, -0.001f, 0.0f}, {1000.0f, -100.0f, -0.001f}, {0.001f, -0.01f, 0.0f}, {-10.0f, 1000.0f, 100.0f}, {-1.0f, 1000.0f, -0.1f}, {1000.0f, -1.0f, 1000.0f}
};
}

// プレイヤークラス
public class OurPlayer extends ap25.Player {
  static final String MY_NAME = "ememy14";
  MyEval eval;
  int depthLimit;
  Move move;
  OurBoard board;
